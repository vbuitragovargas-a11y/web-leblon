...
function PremiumOrb({ color, spinDelay }: { color: string; spinDelay: number }) {
  ...
  return (
    <div className="relative flex items-center justify-center w-full h-full">
      ...
      {/* Outer spinning ring — very subtle */}
      <div
      ...
      {/* Second ring — counter-rotate, dashed */}
      <div
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `linear-gradient(to right, transparent 10%, rgba(${rgb},0.28) 45%, rgba(${rgb},0.28) 55%, transparent 90%)`,
        }}
      />
      ...
      >
        ...
        <div
          ...
          style={{ background: "linear-gradient(180deg, #061311 0%, #020d0b 100%)" }}
        />

        {/* Scene glow — resting state */}
        <div
          className="absolute inset-0 transition-opacity duration-500 pointer-events-none"
          style={{
            background: `radial-gradient(ellipse 70% 65% at 50% 55%, rgba(${rgb},0.08) 0%, transparent 70%)`,
          }}
        />

        {/* Scene glow — hover intensifies */}
        <div
          className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
          style={{
            background: `radial-gradient(ellipse 75% 70% at 50% 50%, rgba(${rgb},0.14) 0%, rgba(${rgb},0.04) 55%, transparent 75%)`,
          }}
        />

        {/* Deep blur layer — depth / second light source */}
        <div
          className="absolute pointer-events-none animate-ambient"
          style={{
            width: "180px", height: "180px",
            top: "10%", left: "calc(50% - 90px)",
            borderRadius: "50%",
        ...
        {/* Second offset glow — creates depth asymmetry */}
        <div
          className="absolute pointer-events-none"
          style={{
            width: "120px", height: "80px",
            top: "20%", left: "calc(50% - 20px)",
            borderRadius: "50%",
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            className="absolute top-0 bottom-0 animate-light-pass"
            style={{
              width: "60px",
              background: `linear-gradient(90deg, transparent 0%, rgba(${rgb},0.05) 50%, transparent 100%)`,
              animationDelay: `${t.delay + 1.5}s`,
              animationDuration: `${5 + t.delay * 0.4}s`,
            }}
          />
        </div>
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 100% 100% at 50% 50%, transparent 42%, rgba(2,13,11,0.7) 100%)",
          }}
        />

        {/* Hover shadow lift — subtle top-edge glow on hover */}
        <div
          ...
          style={{
            background: `linear-gradient(to bottom, rgba(${rgb},0.06) 0%, transparent 100%)`,
          }}
        />
        ...
        <div
          ...
          style={{
            background: "linear-gradient(to bottom, transparent, rgba(8,40,28,0.98))",
          }}
        />
      </div>
      ...
      <div className="flex flex-col flex-1 px-6 pt-5 pb-6">
        ...
        {/* Name */}
        <h3
          className="text-[16px] font-medium text-white leading-snug tracking-[-0.01em] mb-3
        ...
        {/* Description */}
        <p
          className="text-[13px] font-light leading-relaxed mb-4 flex-1"
        ...
        {/* Tags */}
        <p
          className="text-[9px] uppercase tracking-[0.38em] mb-5"
        ...
        {/* CTA */}
        <a
          href="https://wa.me/TODO_WHATSAPP"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 self-start
                     text-[10.5px] uppercase tracking-[0.24em] font-medium
                     text-emerald-400/45 hover:text-emerald-400
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 40% at 50% 55%, rgba(13,74,56,0.22) 0%, transparent 70%)",
        }}
      />
