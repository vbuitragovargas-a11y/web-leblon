...
export default function Doctor() {
  return (
    <section
      className="relative w-full bg-[#061311] overflow-hidden"
      style={{ isolation: "isolate" }}
    >
      {/* 👇 IMAGEN COMO FONDO (ACÁ VA) */}
      <DoctorImage />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 72% 52%, rgba(20,120,100,1) 0%, rgba(6,19,17,0) 65%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, transparent 0%, #061311 100%)",
        }}
      />

      {/* CONTENIDO */}
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-start py-20 md:py-24 gap-10">
        
        {/* TEXTO */}
        <div
          className="flex flex-col gap-6 max-w-[480px]
        ...
        >
          ...
          <div>
            <h2
              className="font-light text-white tracking-tight leading-[1.0]"
              style={{ fontSize: "clamp(2.4rem, 3.5vw, 4.4rem)" }}
            >
              Dra. Sinziana
            </h2>
            <h2
              className="font-light italic leading-[1.05]"
              style={{
          ...
          <div className="flex gap-6 pt-1">
            {[
              ...
              <div key={label} className="border-l border-white/[0.08] pl-4">
                ...
                <p className="text-[9px] uppercase tracking-[0.3em] text-white/25 mt-0.5">
                  {label}
                </p>
              </div>
            ))}
